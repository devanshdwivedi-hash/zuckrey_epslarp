...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const duration = 3000; // 3 seconds total boot sequence
  const intervalTime = 30; // Update frequency (ms)
  ...
  // 1. Boot Sequence Animation (0% -> 100% over 3 seconds)
  ...
  // 2. Navigation Tabs (HOME, UPLOAD, CHAT, GAMES, HELP (lol))
