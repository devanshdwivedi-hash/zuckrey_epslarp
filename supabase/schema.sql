-- ==========================================================
-- Autonomous AI Content Agent — Supabase Schema DDL
-- File: supabase/schema.sql
-- ==========================================================

-- 1. Table: published_posts
...
ALTER TABLE public.published_posts ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ NOT NULL DEFAULT NOW();
ALTER TABLE public.published_posts ADD COLUMN IF NOT EXISTS timestamp TIMESTAMPTZ NOT NULL DEFAULT NOW();
ALTER TABLE public.published_posts ADD COLUMN IF NOT EXISTS vector_embedding JSONB;
...
-- Self-healing column additions for existing installations
ALTER TABLE public.rejected_posts ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ NOT NULL DEFAULT NOW();
ALTER TABLE public.rejected_posts ADD COLUMN IF NOT EXISTS timestamp TIMESTAMPTZ NOT NULL DEFAULT NOW();
